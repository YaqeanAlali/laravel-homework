            ...
            <div class="row">
                ...
                <div class="col-lg-4 right-contents">
                    ...
                    <div class="my-5">
                        ...
                        <form class="form-contact contact_form" action="{{ route('front.message.register') }}" method="post" id="contactForm" >
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                    <input class="form-control" name="spec"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your specialaty'" placeholder = 'Enter your specialaty'>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                            <button type="submit" class="button button-contactForm btn_1">Regester</button>
                            </div>
                        </form>
                    </div>                          
                </div>
